<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="CouponDeals.Company" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <h2>
        <asp:Label ID="lblCompany" runat="server" Text="Create Company"></asp:Label>
    </h2>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form-main">  
        ...
        <div class="col-md-10" id="btnSet" style="text-align:right;" runat="server">
                <asp:Button ID="EditBtn" runat="server" Text="Edit Company" CssClass="btn side-btn " OnClick="EditBtn_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="row">
        ...
        <div class="col-md-12 ">
            ...
            <asp:TextBox ID="txtCompanyID" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
        </div> 
    </div>
    ...
    <div class="form-group row">
    <div class="col-md-12 ">
    <label for="uploadImg">Upload Company Image:</label>
    ...
    <asp:DropDownList ID="ddlCategory" runat="server" CssClass="form-control"></asp:DropDownList>
        ...
        <asp:Button ID="SaveBtn" runat="server" Text="Save" CssClass="btn btn-main" OnClick="SaveBtn_Click"  
              />&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="BackLink" runat="server" CssClass="btn side-btn" NavigateUrl="~/CompanyList.aspx" >Back</asp:HyperLink>
